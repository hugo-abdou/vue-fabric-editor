...
<<<<<<< Updated upstream:src/views/home/index.vue
        <!-- 左侧区域 -->
...
=======
        <div v-if="state.show" style="width: 380px; height: 100%; background: #fff; display: flex">
          <Menu
            ...
            accordion
            @on-select="(activeIndex: number) => (state.menuActive = activeIndex)"
            width="65px"
          >
>>>>>>> Stashed changes:old/src/views/home/index.vue
...
=======
  const _canvas = new fabric.Canvas('canvas', {
    ...
    controlsAboveOverlay: true, // Still show controls when outside clipPath
>>>>>>> Stashed changes:old/src/views/home/index.vue
  });
...
// Get font data Add new font style to use
